...
//this class runs before launch activity
public class MyApplication extends Application {
    ...
    //static method to convert timestamp to proper data format
    ...
    public static void loadPdfSize(String pdfUrl, String pdfTitle, TextView sizeTv) {
        ...
        //using url we can get size from firebase storage
    ...
    private static void saveDownloadedBook(Context context, ProgressDialog progressDialog, byte[] bytes, String nameWithExtension, String bookId) throws IOException {
    ...
    private static void incrementBookDownloadCount(String bookId) {
        ...
        ref.child(bookId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //update new incremented downloads count to database
                DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Books");
